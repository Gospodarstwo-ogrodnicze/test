...
<body>
  ...
  <li><a class="homer" href="cennik"><i class="fa fa-tags"></i> Cennik</a></li>
 ...
 <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script><script  src="skrypty/script.js"></script>
    ...
    <div class="cennik" onclick="location.href='pelargonia';">
        <div class="cennikt">
		<a>&nbsp&nbspPelargonia</a>
		</div>
        <img src="images/pelargonia.png" style="float: left; margin-right: 20px" />
        <div class="cenniko">
        <a>Pelargonia - tutaj będzie jakiś opis</a>
        </div>
    </div>
            
    <div class="cennik" onclick="location.href='kwiaty-wiszace';">
        <div class="cennikt">
		<a>&nbsp&nbspSurfinia wisząca</a>
		</div>
        <img src="images/wiszace.png" style="float: left; margin-right: 20px" />
        <div class="cenniko">
        <a>Surfinia wisząca - tutaj będzie jakiś opis</a>
        </div>
    </div>
